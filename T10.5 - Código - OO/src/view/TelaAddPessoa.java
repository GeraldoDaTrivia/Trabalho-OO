...
public class TelaAddPessoa implements ActionListener {
	...
	//Novo cliente
		...
		//Criacao de novo Cliente
				...
				if(dddString.matches("[0-9]+") && numString.matches("[0-9]+")) {
					
					telDdd = Integer.parseInt(dddString);
					telNum = Integer.parseInt(numString);
					int id;
	...
	//Novo Funcionario
		...
		//Criacao de novo Funcionario
				...
				if(dddString.matches("[0-9]+") && numString.matches("[0-9]+") && rgString.matches("[0-9]+")
						&& cepString.matches("[0-9]+") && casaString.matches("[0-9]+")) {
					
					numRg = Integer.parseInt(rgString);
					telDdd = Integer.parseInt(dddString);
					telNum = Integer.parseInt(numString);
					...
					JOptionPane.showMessageDialog(null, "O telefone, RG, CEP e nº da casa só podem ser compostos por números.\n"
							+ "Por favor, tente novamente.", null, JOptionPane.INFORMATION_MESSAGE);
